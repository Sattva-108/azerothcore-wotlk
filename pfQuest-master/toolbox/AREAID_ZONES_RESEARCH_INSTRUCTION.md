...
## ⚠️ КРИТИЧЕСКОЕ ОБНОВЛЕНИЕ ПЛАНА

### БЛОКИРУЮЩАЯ ПРОБЛЕМА ОБНАРУЖЕНА
**Все creatures в AzerothCore имеют areaId = 0**
- pfQuest ищет NPCs по areaId
- База данных содержит только zoneId (исправлены)
- **ПРИОРИТЕТ 0:** Заполнить правильные areaId перед продолжением

### НОВАЯ ПОСЛЕДОВАТЕЛЬНОСТЬ BRANCHES
**Branch 0:** **КРИТИЧЕСКИЙ** - areaId population (0.5-1 час)
**Branch 1:** Критические зоны ✅ ГОТОВ (кроме areaId)
