...
local major, minor, fix = hcstrsplit(".", tostring(GetAddOnMetadata("pfQuest-ascension", "Version")))
        ...
        if arg1 == "pfqe" then
            ...
            if v == "VERSION" and remoteversion then
                if remoteversion > localversion then
                    ...
                    if not alreadyshown then
                        print("|cff33ffccpf|cffffffffQuest |cffcccccc[Ascension WoW DB] |cffff5555[RELEASE]|r New version available! |cff66ccffhttps://github.com/Bennylavaa/pfQuest-ascension|r")
                        alreadyshown = true
                    end
                end
            end
            ...
            if v == "PING?" then
                for _, chan in ipairs(loginchannels) do
                    SendAddonMessage("pfqe", "PONG!:"..GetAddOnMetadata("pfQuest-ascension", "Version"), chan)
                end
            end
            if v == "PONG!" then
